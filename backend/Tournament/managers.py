...
class TournamentSetupManager:
    @staticmethod
    def create_tournament_and_host_tournament_player(validated_data: TournamentCreationSerializer.validated_data) -> Tournament:
        try:
            with transaction.atomic():
                ...
                tournament = Tournament.objects.create(
                    host_user=host_user,
                    name=validated_data.get('custom_name', None),
                    player_amount=validated_data.get('player_amount')
                )

                host_name_in_tournament = validated_data['host_user_custom_name'] if validated_data['host_user_custom_name'] else host_user.username
                TournamentPlayer.objects.create(
                    tournament=tournament,
                    user=host_user,
                    display_name=host_name_in_tournament
                )
        ...
        try:
            with transaction.atomic():
                ...
                try:
                    ...
                    tournament.end_ts = timezone.now()
                    tournament.save()
...
class OLD_TournamentSetupManager:
    @staticmethod
