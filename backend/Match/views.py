...
class LaunchSingleMatchView(APIView):
	...
	def post(self, request):
		...
		match, host_player, guest_player = Match.objects.create_match_and_its_players(token.host_user, token.guest_user)
		...
		return redirect(pong_match_url) # this is prob not correct as this is a single-page app; will talk with Dorian about how to do it correctly