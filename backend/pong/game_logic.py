...
class PongGame:
    def __init__(self):
        ...
        self.player1_y = PLAYGROUND_HEIGHT // 2  # Initial position for player 1
        self.player2_y = PLAYGROUND_HEIGHT // 2  # Initial position for player 2
        self.ball_x = PLAYGROUND_WIDTH - WALL_MARGIN - PLAYER_WIDTH - BALL_WIDTH // 2  # Initial position for ball (x-coordinate)
